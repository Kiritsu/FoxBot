...
namespace Fox.Commands.TypeParsers
{
    ...
    {
        public override async Task<TypeParserResult<DiscordMember>> ParseAsync(Parameter parameter, string value, ICommandContext context, IServiceProvider provider)
        {
            ...
            if (ctx.DatabaseContext.Guild.Levenshtein)
            {
